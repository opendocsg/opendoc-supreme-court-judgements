...
layout: single
---
# Firstlink Energy Pte Ltd v Creanovate Pte Ltd 
...
**Counsel Name(s)** :Low Chai Chong (with Loh Kia Meng) for the plaintiffs; Tan Teng Muan (with Loh Li Qing) for the defendants 
...
1\. This is an application by the Plaintiffs to set aside interlocutory judgment entered by the Defendants in default of pleadings: the Defendants allege that the Plaintiffs defaulted when they failed to file their Reply and Defence to Counterclaim within the time directed by the court. 
...
_Plaintiffs’ application is allowed._ 

 C opyright © Government of Singapore. 


Source: [link](https://www.singaporelawwatch.sg/Portals/0/Docs/Judgments/[2006] SGHC 19.pdf)
