...
15     Turning first to precedent, both _Rasmachayana_ and _OCBC_, which were the decisions relied on by Mr Choy, were decisions of High Court Judges. If the present case cannot be distinguished, I would be bound by the _ratio decidendi_ of these decisions (_Peter Low LLC v Higgins, Danial Patrick_ <span class="citation">\[2017\] SGHCR 18</span> at \[31\]). In my view, however, neither _Rasmachayana_ nor _OCBC_ provides a direct answer to the General Issue.
