...
10     In determining whether an extension of time is appropriate, all the circumstances of the case will be considered, in particular (a) the length of the delay; (b) the sufficiency of any explanation given in respect of the delay; and (c) the prospects of the application: see _Chew Eng Han v Public Prosecutor_ <span class="citation">\[2017\] 2 SLR 935</span> at \[2\].
