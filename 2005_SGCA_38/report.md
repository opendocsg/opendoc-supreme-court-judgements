...
1       This was an appeal against the decision of Lai Kew Chai J in _United Project Consultants Pte Ltd v Leong Kwok Onn_ [2005] 1 SLR 537 where he rejected the appellant’s claim against the respondent for negligence and/or breach of contract in the discharge of the latter’s duties as the appellant’s auditor and tax agent. We could not agree with the reasoning of the trial judge below and accordingly allowed the appeal. We now give our reasons. 
...
20     Before proceeding any further, one should bear in mind the salutary principle that an appellate court should not interfere with the trial judge’s finding of fact unless it can be shown that his findings were plainly wrong. It is only when the lower court’s findings are shown to be unsustainable on the evidence that an appellate court will be free to evaluate the evidence and make its own findings: _MK (Project Management) Ltd v Baker Marine Energy Pte Ltd_ [1995] 1 SLR 36. 
...
_The appellant’s loss was precisely the kind that the respondent was to prevent_ 
