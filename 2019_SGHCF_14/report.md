...
21     The Brothers emphasise that the taking of an account functions as a process, not as a remedy (_Lalwani Shalini Gobind and another v Lalwani Ashok Bherumal_ at \[26\]). It does _not_ follow, in my view, that remedies are not available at the end of the process. The Court of Appeal in _Chng Weng Wah v Goh Bak Heng_ summarised the process of taking accounts as a three-step process, at \[22\], with “any consequential relief” listed as the last step. The Court of Appeal stated at \[20\]:
...
65     It is not disputed that the standard that executors should be held to is that of good faith and reasonableness (see _ADP v ADT_ at \[10\]). Given the Testator’s wishes and their respect for their Mother, I find that it was reasonable for the Brothers to have refrained from renting out the Eastern Mansion property before its sale.
