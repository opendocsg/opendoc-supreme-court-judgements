...
None of the provisos to s 94 applied to the facts of this case. The application of s 94 has been considered by the Court of Appeal in **Ng Lay Choo Marion v Lok Lai Oi** [1995] 3 SLR 221. There, the court held that where the alleged terms of the oral agreement are in addition to and therefore inconsistent with the written contract, that evidence is inadmissible. 
