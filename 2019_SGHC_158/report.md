...
16     Order 45, rule 6 is a provision allowing the court to set a time on an order where none was previously specified. In _Mok Kah Hong v Zheng Zhuan Yao_ \[2016\] 3 SLR 1 (“_Mok Kah Hong_”) at \[46\], the Court of Appeal made clear that the court may utilise O 45 r 6 to impose a timeframe for payment where there is sufficient material before the court to warrant the exercise of such discretion under O 45 r 6(2). Its guidance is as follows:
