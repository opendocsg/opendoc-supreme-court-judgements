...
2       At first blush, the issue appears to have been conclusively decided by Tan Siong Thye J (“Tan J”) in the earlier decision of _SH Design & Build Pte Ltd v BD Cranetech Pte Ltd_ (“_SH Design_”). There, Tan J held that the adjudicator “had jurisdiction to account for the Bond Proceeds because these were included in the Payment Response” (_SH Design_ at \[57\]).
...
20     In determining whether s 10(1) SOPA is a mandatory provision, the query is whether it is “so important that it is the legislative purpose that an act done in breach of that provision should be invalid” (_Comfort Management_ at \[75\]; see also _Australian Timber Products Pte Ltd v A Pacific Construction & Development Pte Ltd_ at \[75\], per Woo Bih Li J).
