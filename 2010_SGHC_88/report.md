...
Reference was made to a number of local decisions where our courts have presumed Singapore law to be the same as foreign law (see, _eg_ , _K-Rex Finance Ltd v Cheng Chih Cheng_ [1992] 3 SLR(R) 296, _Goh Chok Tong v Tang Liang Hong_ [1997] 1 SLR(R) 811, _Parno v SC Marine Pte Ltd_ [1999] 3 SLR(R) 377 and _Ong Jane Rebecca v Lim Lie Hoa_ [2003] SGHC 126). Accordingly, PSB argued that Rule 18 applies, and that it is entitled to judgment on the counterclaim. 
