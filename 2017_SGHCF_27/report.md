...
**Counsel Name(s)** :Suchitra A/P K Ragupathy (Dentons Rodyk & Davidson LLP) for the plaintiff; The defendant in person. 
...
8       It is well established that in determining whether to grant an extension of time to file an appeal, the court will consider the following four factors in a holistic manner (see _Lee Hsien Loong v Singapore Democratic Party and others and another suit_ [2008] 1 SLR(R) 757 (“ _Lee Hsien Loong_ ”) at [18] and [28]): 
 ...
 (d) the prejudice caused to the would-be respondent if an extension of time was in fact granted. 
