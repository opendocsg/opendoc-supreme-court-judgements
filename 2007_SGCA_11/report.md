...
6       Counsel for the prosecution referred to the principles expressed by Lord Denning in _Ladd v Marshall_ [1954] 1 WLR 1489, and submitted that those principles had been adopted by the court in _Juma’at bin Samad v PP_ [1993] 3 SLR 338 (“ _Juma’at bin Samad_ ”). The learned prosecutor argued that none of the three conditions in _Ladd v Marshall_ had been satisfied. The conditions are, first, the nonavailability of the evidence in the proceedings below; second, the evidence would have had an important influence at the trial below; and third, the evidence must be credible, though not necessarily incontrovertible. Mr Yeo argued to the contrary, that the conditions in _Ladd v Marshall_ had been met, and further, that we should allow the evidence under s 55(1) of the Supreme Court of Judicature Act (Cap 322, 1999 Rev Ed) (“SCJA”) which provides as follows: 
