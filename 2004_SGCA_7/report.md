...
40     In the instant case, words to the effect that the appellant should tell the truth (or not to tell lies) were coupled with the representations that first, the appellant would not be able to tell a lie 
