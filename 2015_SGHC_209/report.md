...
7       Both parties referred me to the two High Court cases that have discussed the amended O 1 r 9 in some detail: _Bulk Trading SA v Pevensey Pte Ltd and another_ [2015] 1 SLR 538 (“ _Bulk Trading_ ”) and _Allergan, Inc and another v Ferlandz Nutra Pte Ltd_ [2015] 2 SLR 94. In _Bulk Trading_ , Steven Chong J identified a range of factors the court ought to consider in deciding an application under O 1 r 9(2). The list includes the following: 
